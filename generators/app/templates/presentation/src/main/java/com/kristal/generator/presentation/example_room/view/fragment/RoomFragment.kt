package <%= appPackage %>.presentation.example_room.view.fragment
...
import <%= appPackage %>.R
import <%= appPackage %>.presentation.example_room.adapter.BookAdapter
import <%= appPackage %>.presentation.example_room.model.BookModel
import <%= appPackage %>.presentation.example_room.presenter.RoomPresenter
import <%= appPackage %>.presentation.example_room.view.RoomView
...
class RoomFragment : BaseFragmentMvp<RoomPresenter>(), RoomView {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        adapter = BookAdapter(recyclerView)
    }
