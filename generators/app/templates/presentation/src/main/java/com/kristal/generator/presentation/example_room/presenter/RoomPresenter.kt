package <%= appPackage %>.presentation.example_room.presenter

import android.arch.lifecycle.ViewModelProviders
import <%= appPackage %>.presentation.example_room.mapper.toLoanCompleteModel
...
import <%= appPackage %>.presentation.example_room.view.viewmodel.factory.ViewModelFactory
